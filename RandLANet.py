...
def compute_loss(end_points, cfg):
    ...
    logits = end_points['logits'] #[B,3,N]
    labels = end_points['labels'] #[B,N,]
    #[B*N,3] [B*N,]
    ...
    # print('test',logits.shape,labels.shape,valid_logits.shape)
    # exit()
